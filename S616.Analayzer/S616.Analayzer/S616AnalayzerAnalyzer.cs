...
namespace S616.Analayzer
{
    ...
    public class S616AnalayzerAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "S616Analayzer";
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            {
                // iterate through all statemants in tree
                ...
                foreach (var statement in root.DescendantNodes().OfType<StatementSyntax>())
                {
                    ...
                    {
                        var diagonistic = Diagnostic.Create(Rule, statement.GetFirstToken().GetLocation());
                        treeContext.ReportDiagnostic(diagonistic);
                    }
                }
            });
        }
